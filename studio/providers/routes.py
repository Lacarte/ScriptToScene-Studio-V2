...
Policy, uniformly: loopback-only (`studio.security.is_loopback_remote`) because
...
from studio.providers.catalog import build_catalog, catalog_version, selected_providers
