...
Regenerates every file in studio/workflows/fixtures/ from a tiny canonical
...
Run from the repository root:
    ...
    python studio/workflows/fixtures/generate.py
...
from studio.workflows.sample_data import (  # noqa: E402
...
def build() -> None:
    ...
    _write_json("manifest.json", {
        ...
        "generated_by": "studio/workflows/fixtures/generate.py",
        "project_id": SAMPLE_PROJECT_ID,
    })
