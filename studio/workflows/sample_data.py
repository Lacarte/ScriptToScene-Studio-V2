...
The bundled fixtures under ``studio/workflows/fixtures/`` are the ONLY files
...
they are regenerated with ``studio/workflows/fixtures/generate.py``.
"""
...
def validate_fixtures() -> list[str]:
    ...
    if not FIXTURES_DIR.is_dir():
        return ["studio/workflows/fixtures/ does not exist — run fixtures/generate.py"]
