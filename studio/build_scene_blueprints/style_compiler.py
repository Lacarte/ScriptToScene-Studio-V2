...
DEFAULT_NEGATIVE_RULES = {
    ...
    "stickman_glow": ["avoid photorealism", "avoid detailed anatomy", "avoid bright backgrounds", "avoid cheerful mood", "avoid multiple figures", "avoid environmental detail"],
