...
particular it does **not** import `studio.workflows.adapters.common` —
...
_GENERIC_MESSAGE = {
    ...
    "scene_blueprint": "The scene blueprint provider failed while planning scenes.",
    "tts": "The speech provider failed while synthesizing audio.",
    "storyboard": "The storyboard provider failed while generating images.",
    "animator": "The animator provider failed while generating assets.",
}
...
def _safe_details(details: Any) -> dict | None:
    ...
    if not isinstance(details, dict):
        return None
    from studio.workflows.redaction import redact
