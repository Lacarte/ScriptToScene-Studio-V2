...
from studio.workflows.config_migrations import (
...
DOCUMENTED_ALIASES = {
    ...
    ("scene_blueprint", "n8n"): "n8n",
    ("tts", "kokoro"): "kokoro",
    ("tts", "inworld"): "inworld",
    ("storyboard", "gemini"): "gemini_ws",
    ("storyboard", "gemini_ws"): "gemini_ws",
    ("storyboard", "webhook"): "wavespeed_webhook",
    ("storyboard", "wavespeed_webhook"): "wavespeed_webhook",
    ("storyboard", "direct"): "wavespeed_direct",
    ("storyboard", "wavespeed_direct"): "wavespeed_direct",
    ("animator", "grok"): "grok_automa",
    ("animator", "midjourney"): "grok_automa",
    ("animator", "grok_automa"): "grok_automa",
    ("animator", "kie-ai"): "kie_ai",
    ("animator", "kie_ai"): "kie_ai",
}
...
LEGACY_SELECTION_FIELDS = (
    ...
    ("node_config_storyboard", "provider", "webhook", "storyboard", "wavespeed_webhook"),
    ("node_config_animator", "provider", "grok", "animator", "grok_automa"),
    ("http_override", "provider_override", "gemini", "storyboard", "gemini_ws"),
    ("http_legacy", "provider", "kie-ai", "animator", "kie_ai"),
    ("pipeline", "tts_provider", "inworld", "tts", "inworld"),
    ("pipeline", "storyboard_provider", "direct", "storyboard", "wavespeed_direct"),
    ("pipeline", "animator_provider_override", "midjourney", "animator", "grok_automa"),
    ("preflight", "storyboard_provider", "gemini", "storyboard", "gemini_ws"),
    ("preflight", "asset_provider", "grok", "animator", "grok_automa"),
)
...
class AliasMatrixTests(unittest.TestCase):
    ...
    def test_an_unknown_alias_does_not_resolve(self):
        ...
        self.assertIsNone(hub.get("storyboard", "midjourney"))
...
class SelectionAliasAndSettingsFormatTests(unittest.TestCase):
    ...
    def test_builtin_is_domain_aware(self):
        ...
        self.assertEqual(
            normalize_selection_alias("builtin", domain="scene_blueprint"), "n8n"
        )
        self.assertEqual(
    ...
    def test_v1_settings_upgrade_is_lossless_and_idempotent(self):
        v1 = {
            ...
            "domains": {
                ...
                "storyboard": {"per_provider": {}},
                "animator": {"selected_provider": "grok", "per_provider": {}},
            },
        }
        legacy = {
        ...
        self.assertEqual(
            once["domains"]["storyboard"]["selected_provider"], "gemini_ws"
        )
        # Explicit selection always wins over the legacy key, and is normalized.
        self.assertEqual(
            once["domains"]["animator"]["selected_provider"], "grok_automa"
        )
        self.assertEqual(
