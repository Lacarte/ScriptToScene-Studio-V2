...
from studio.workflows.validation import MAX_DOCUMENT_BYTES, validate_workflow, validation_errors
...
class BrandingUploadLimitTests(unittest.TestCase):
    def setUp(self):
        ...
        patcher = patch("studio.workflows.routes.BRANDING_DIR", self.tempdir)
        patcher.start()
    ...
    def test_asset_count_cap_is_enforced(self):
        with patch("studio.workflows.routes.MAX_BRANDING_ASSETS", 2):
