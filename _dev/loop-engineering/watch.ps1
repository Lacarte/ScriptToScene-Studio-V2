...
#
# Usage:  powershell -File _dev\loop-engineering\watch.ps1
# Ctrl+C stops watching; it never touches the run itself (read-only).

param([int]$PollSeconds = 2)

$ErrorActionPreference = 'SilentlyContinue'
$transcriptDir = "C:\Users\Admin\.claude\projects\d---Workspace--Development--Scripts--Python-ScriptToScene-Studio-V2"
